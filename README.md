...
![Neighbor discovery phase](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/assets/Neighbor%20discovery%20phase.png)
...
![State 0](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/assets/State%200.png)

![State 1](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/assets/State%201.png)

![State 2](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/assets/State%202.png)
...
![Demostration of the algorithm cost](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/assets/Standar%20method%20formula.gif)
...
![Arithmetic progresion](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/assets/Arithmetic%20progresion.png)

Check if the difference is constant:

![Check if the difference is constant](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/assets/Constant%20demostration.png)

Calculate the difference between all adjacent terms:

![Calculate the difference between all adjacent terms](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/assets/Difference%20between%20all%20adjacent%20terms.png)

![Simplify](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/assets/Simplify.png)

Generic formula of a arithmetic sucesion:

![Generic formula of a arithmetic progresion sucesion](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/assets/Generic%20formula%20of%20a%20arithmetic%20progresion%20sucesion.png)

Substitution and simplify:

![Substitution and simplify](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/assets/Substitution%20and%20simplify.png)
...
* If you want to know more information about the NVM and the different variables stored in it to make the state machine work, it is recommended to see the [nvm.c](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/source/nvm/nvm.c) and [nvm.h](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/header/nvm/nvm.h) files for a better understanding.
...
## Limitations
* The network must have a number of fixed nodes. This value is determined in the [common.h](https://github.com/abvg9/DWM1001_Distances_measurement/blob/main/header/common.h) file, in the NET_NUM_NODES variable.
```c++
