...
typedef enum {
  ...
  was_a_tag_in_last_state = initiator_index + 1, // Indicate that in the last state this node was a tag.
  neighbors_start_address = was_a_tag_in_last_state + 1 // Initial address of the neighbors.
} nvm_memory_position;
